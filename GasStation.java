...
/* DEDUCTIONS:- 
 * 1. The car can travel only from left to right...
 * 2. We first assume each gas station as starting point and obtain the possibility of whether the car can reach next station or not...
 * 3. The negative values are bad values...
 * 4. Also the values to the left of negative values are also bad since we will encounter negative values...
 * 5. We plan our path such that we do not encounter minimum values at the starting...
*/